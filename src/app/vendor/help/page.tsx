...
export default function VendorHelpPage() {
  ...
  useEffect(() => {
    ...
    const subscription = supabase
      .channel("support_messages_vendor")
      .on(
        "postgres_changes",
        {
          event: "UPDATE",
  ...
  return (
    <section className="min-h-screen bg-hospineil-base-bg py-16 px-6">
      <div className="max-w-4xl mx-auto">
        {/* Header */}
        <div className="mb-8">
          <Link href="/vendor/dashboard" className="inline-flex items-center gap-2 text-hospineil-primary hover:text-hospineil-accent transition-colors duration-300 mb-4">
